...
class SuperheroViewsTest(TestCase):
    ...
    def test_get_valid_single_superhero(self):
        ...
        response = self.client.get(reverse('get_delete_put_single_superhero', kwargs={'id': self.loki.pk}))
    ...
    def test_get_invalid_single_superhero(self):
        ...
        response = self.client.get(reverse('get_delete_put_single_superhero', kwargs={'id': 30}))
