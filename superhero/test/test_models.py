...
class SuperheroTest(TestCase):
    ...
    def setUp(self):
        Superhero.objects.create(
            name='Thor', publisher='Marvel', public=True
        )
        Superhero.objects.create(
            name='Batman', publisher='DC', public=False
        )
    ...
    def test_superhero_information(self):
        ...
        self.assertEqual(
            thor.get_information(), "Thor belongs to Marvel")
        self.assertEqual(
            batman.get_information(), "Batman belongs to DC")