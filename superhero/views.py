    ...
    def get(self, req, id=None):
        if id:
            try:
                ...
                return Response(
                    {"superhero": serializer.data}, status=status.HTTP_200_OK
                )

            except Superhero.DoesNotExist:
                return Response(
                    {"msg": f"superhero with id {id} not found"},
    ...
    def delete(self, req, id=None):
        ...
        if id:
            try:
                ...
                return Response(
                    {"superheroes": serializer.data, "status": "deleted"},
                    status=http_status,
                )
